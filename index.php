...
<html style="margin-top:0.8em; margin-right:1.1em; height:100%; width=100%; overflow: hidden;">
  ...
  <head>                    
    ...
    <script src="http://qk.demokratisch-praktisch-gut.de/libs/jquery.js"></script>                                                                                                                                                                
    <script src="http://qk.demokratisch-praktisch-gut.de/libs/datajs.js"></script>                                                                                        
    <script src="http://qk.demokratisch-praktisch-gut.de/libs/jaydata.js"></script>                                                                                       
    <script src="http://qk.demokratisch-praktisch-gut.de/libs/jaydataproviders/oDataProvider.js"></script>                                                                
    <script src="http://qk.demokratisch-praktisch-gut.de/libs/disco.ontology.js"></script>                                                                                
    <script>                                                                                                                                                       
        //disco.js                                                                                                                                                 
