...
function uc_browsing_content_init_gui()
{
  ...
  my_html = my_html + '                    <textarea id=\'' + this.current_panel + '_content_fulltext\' onfocus=\"' + on_focus_str + '\" onblur=\"' + on_blur_str + '\" name=\"myname\" wrap=physical style=\"width:100%; height:100%; border-style:none;\">';
