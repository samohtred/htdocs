...
c_DEFAULT_UC_BROWSING_SETUP.tree_data_src_type = c_DATA_SOURCE_TYPE_ID_DISCO; // c_DATA_SOURCE_TYPE_ID_XML;  //
c_DEFAULT_UC_BROWSING_SETUP.tree_data_src_path = "test.disco-network.org/api/odata"; 
...
c_DEFAULT_UC_BROWSING_SETUP.tree_last_selected = "575";  //"12"; //"root";
c_DEFAULT_UC_BROWSING_SETUP.tree_locked_item = "575"  //"root";
